...
mean_by_country_cast=dcast(mean_by_country_melt,Country~Indicator,fun.aggregate = mean,na.rm=TRUE, na.action=NULL)  #contains all indicators for all countries not just HI+LI
